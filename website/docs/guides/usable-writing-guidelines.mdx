...
### What is "usable writing"?
"Usable writing" is interface copy that is designed to help people accomplish their goals quickly and easily.

### Why is it important?
Usable writing ensures that our products are accessible and user-friendly.
Studies show that users of digital products and websites scan for what they need—like headings, keywords, bullet points, links, and calls-to-action—and skip over long body text and sections or pages that don't seem relevant to them.
(TK accessibility input)
...
These guidelines are not intended as a style guide for author or book descriptions, catalogs, marketing materials, or other types of editorial copy.
