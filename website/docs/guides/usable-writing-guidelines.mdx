...
- **Write for all users.**
  ...
  Everyone has a limited ability to process information called cognitive capacity.
	Cognitive capacity can be lower when we are tired, overwhelmed, experiencing cognitive disability, or aren't fluent in a domain or language.
	It is depleted more quickly by abstract concepts, difficult words, and tasks that require us to hold a lot of information in our heads.
