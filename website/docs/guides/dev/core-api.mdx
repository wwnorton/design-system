...
| `$selection-background-color` | <ColorChip>`null` (unset)</ColorChip>     | The background color of user-selected text                      |
| `$selection-text-color`       | <ColorChip>`null` (unset)</ColorChip>		| The text color of user-selected text                            |
