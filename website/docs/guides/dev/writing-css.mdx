...
Using [role tokens](/docs/foundations/design-tokens#role-tokens) will facilitate theming in your application since role tokens can be customized, whereas [system tokens](/docs/foundations/design-tokens#system-tokens) cannot.
