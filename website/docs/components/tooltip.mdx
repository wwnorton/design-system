...
<img
	alt="A tooltip with indicators calling out the corresponding anatomy items of a solid navy tooltip container, text label of “Text content,” and an arrow pointing to an info icon located below the tooltip."
	src={useBaseUrl('/img/Anatomy_tooltip.png')}
/>

1. **Tooltip Container** - an outline or background sets the tooltip apart.
...
In the Norton design system, a tooltip can only be used to [name or describe](https://www.w3.org/WAI/ARIA/apg/practices/names-and-descriptions/) its related element.
...
:::warning Naming tooltips & screen reader experience
...
:::warning Describing tooltips & screen reader experience
