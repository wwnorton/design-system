...
import { Modal, CalloutSuccess, CalloutError } from '@wwnds/react';
...
<CalloutSuccess title="Do">
	<ul>
		<li>Do use a modal to confirm irreversible actions, such as deleting content.</li>
		<li>Do use a modal to interrupt the user when it will help them accomplish their tasks.</li>
		<li>Do be careful about ambiguous action buttons, such as "Yes" or "No".</li>
	</ul>
</CalloutSuccess>

<CalloutError title="Don't">
	<ul>
		<li>Don't overuse modals. They should be used sparingly and thoughtfully.</li>
		<li>Don't write long titles for modals. They should be clear and concise.</li>
	</ul>
</CalloutError>
