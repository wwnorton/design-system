...
<CalloutSuccess title="Do">
	<ul>
		<li>Do use a link when…</li>
		<ul>
			<li>It would be useful to "Copy", "Open in a new tab", or "Bookmark" the destination URL.</li>
			<li>The text content is embedded in a sentence, and does not need margins or padding.</li>
			<li>The text content conveys location, not an action (for example: a link that references a resource).</li>
			<li>You want to record the navigation in the user's browser history.</li>
		</ul>
		<li>Do style links so that they are visually different from plain text, and indicate that they can be clicked.</li>
	</ul>
</CalloutSuccess>
...
<Callout title="Consider using buttons if..." border="left">
