...
A step indicator includes:
1. **Steps**
1. **Connector** (optional)

A step marker includes:
1. **A state indicator**
1. **A label**

## States
Completion
- Shows whether the user has completed a step. It can be either completed or incomplete.
Current
- Shows the current step that the user is on. Only one step can be current at a time. (Indicated with [aria-current=“step”] (https://w3c.github.io/aria/#aria-current).)
