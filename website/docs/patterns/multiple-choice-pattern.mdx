...
### Display the stem and responses in the same view
...
We've chosen 5 as the design system's preferred limit for most cases, but this depends heavily on the amount of information in the stem and answer choices.

image

:::note Why?
Multiple choice requires us to hold the question stem and all of the answer choices in our working memory.
The more answer choices there are, the more difficult this becomes.

This can prevent us from even being able to answer the question when we are experiencing impairment of our working memory.
:::
...
- Screen magnification users may miss the feedback entirely if it was out of view when it appeared.
- The question view is already visually and cognitively dense.
Adding feedback to this view can disorient, distract, and overwhelm users, preventing them from absorbing it.

{/* TODO: RESUME HERE */}
- Screen readers need to be told when content appears, which does not happen automatically, so the experience needs to be carefully designed the user needs to expect it, and which have difficulty managing focus when unanticipated content appears.
