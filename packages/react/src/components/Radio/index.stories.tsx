...
const Thumbnail = (props: { className?: string }): JSX.Element => {
	const { className } = props;
	return (
		// https://fontawesome.com/license
		<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="book" className={className} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
