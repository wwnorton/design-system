...
export const Popper = React.forwardRef<HTMLDivElement, PopperProps>(({
	...
	const modifiers = React.useMemo(() => [
		...
		arrowElement, arrowPadding, arrowProp, boundary,
		distance, enableArrow, enableFlip, enablePreventOverflow,
		flipOptions, matchWidth, modifiersProp, offset, preventOverflowOptions,
	]);
