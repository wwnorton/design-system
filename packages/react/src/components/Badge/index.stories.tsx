...
export const InlineWithText = () => (
	<section style={{ maxWidth: '32rem' }}>
		<h2>
			Example heading <Badge>Metadata</Badge>
		</h2>
		<p>
			This story demonstrates how the badge component is sized relative to adjacent text. The badge
			found in the heading and at the end of this sentence are slightly smaller than their
			surrounding text. <Badge color="red">15</Badge>
		</p>
	</section>
);
