...
- ci: add initial Storybook testing ([833ebcf](https://github.com/wwnorton/design-system/commit/833ebcf))
- ci: add Node 22 to main testing suite ([8261a38](https://github.com/wwnorton/design-system/commit/8261a38))
- ci: run prepare steps directly in storybook tests ([29eabbd](https://github.com/wwnorton/design-system/commit/29eabbd))
- ci: run storybook tests in playwright image ([9396f35](https://github.com/wwnorton/design-system/commit/9396f35)), closes [/storybook.js.org/docs/writing-tests/in-ci#2](https://github.com//storybook.js.org/docs/writing-tests/in-ci/issues/2)
- ci: run storybook tests with coverage ([5e7ebc9](https://github.com/wwnorton/design-system/commit/5e7ebc9))
- chore: add chromatic config ([b7b891c](https://github.com/wwnorton/design-system/commit/b7b891c))
...
- chore: only spellcheck when valid files are found ([64000a0](https://github.com/wwnorton/design-system/commit/64000a0))
- chore: potential fix for code scanning alert no. 110: Workflow does not contain permissions ([d289eb1](https://github.com/wwnorton/design-system/commit/d289eb1))
- chore: re-add changelog preset config ([13b3665](https://github.com/wwnorton/design-system/commit/13b3665))
- chore: regenerate 1.9.1 notes ([d428815](https://github.com/wwnorton/design-system/commit/d428815))
- chore: remove duplicate storybook testing config ([e094f49](https://github.com/wwnorton/design-system/commit/e094f49))
- chore: set the node.js version in amplify directly ([516821e](https://github.com/wwnorton/design-system/commit/516821e))
- chore: simplify storybook job name ([9ce2d6e](https://github.com/wwnorton/design-system/commit/9ce2d6e))
- chore: try out chromatic ([7160cd9](https://github.com/wwnorton/design-system/commit/7160cd9))
- chore: upgrade storybook to v9 ([7114210](https://github.com/wwnorton/design-system/commit/7114210))
- chore: use correct node variable ([5433986](https://github.com/wwnorton/design-system/commit/5433986))
- chore(deps-dev): bump axios from 1.7.9 to 1.8.4 ([eb4480a](https://github.com/wwnorton/design-system/commit/eb4480a))
- chore(deps-dev): bump vite from 6.0.3 to 6.2.3 ([9f2e17c](https://github.com/wwnorton/design-system/commit/9f2e17c))
- chore(deps): bump @babel/helpers from 7.26.0 to 7.27.0 ([f6b65ef](https://github.com/wwnorton/design-system/commit/f6b65ef))
- chore(deps): bump @babel/runtime from 7.26.0 to 7.27.0 ([eff64ae](https://github.com/wwnorton/design-system/commit/eff64ae))
- chore(deps): bump codecov/codecov-action from 4 to 5 ([704a0f0](https://github.com/wwnorton/design-system/commit/704a0f0))
- chore(deps): bump nanoid from 3.3.7 to 3.3.8 ([2216265](https://github.com/wwnorton/design-system/commit/2216265))
